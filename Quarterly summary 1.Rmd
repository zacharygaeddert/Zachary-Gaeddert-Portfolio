...
```{r include = FALSE}
nj11 <- read_csv('raw data/NJ11.csv') 
...
nj22 <- read_csv('raw data/NJ22.csv')
...
nj33 <- read_csv('raw data/NJ33.csv')
...
nj44 <- read_csv('raw data/NJ44.csv')
...
njmap <- st_read('raw data/acs2019_5yr_B01003_86000US08403.shp') %>% 
