...
```{r include = FALSE}
coned <- read.csv('raw data/NY/ConEd2.csv') %>% 
...
nyseg <- read.csv('raw data/NY/NYSEG2.csv') %>% 
  select(Company, Developer, Application...Job.., Substation, PV..kWAC.,
         Application.Approved.Date...Utility., Project.Complete..Y.N., Zip.Code,
         Metering..NA...NM...RNM...CDG.)
or <- read.csv('raw data/NY/O^0R2.csv') %>% 
  select(Company, Developer, Application...Job.., Substation, PV..kWAC.,
         Application.Approved.Date...Utility., Project.Complete..Y.N., Zip.Code,
         Metering..NA...NM...RNM...CDG.)
nimo <- read.csv('raw data/NY/Niagara Mohawk (NatGrid)2.csv') %>% 
  select(Company, Developer, Application...Job.., Substation, PV..kWAC.,
         Application.Approved.Date...Utility., Project.Complete..Y.N., Zip.Code,
         Metering..NA...NM...RNM...CDG.)
ch <- read.csv('raw data/NY/CH2.csv') %>% 
  select(Company, Developer, Application...Job.., Substation, PV..kWAC.,
         Application.Approved.Date...Utility., Project.Complete..Y.N., Zip.Code,
         Metering..NA...NM...RNM...CDG.)
pseg <- read.csv('raw data/NY/PSEG2.csv') %>% 
  select(Company, Developer, Application...Job.., Substation, PV..kWAC.,
         Application.Approved.Date...Utility., Project.Complete..Y.N., Zip.Code,
         Metering..NA...NM...RNM...CDG.)
